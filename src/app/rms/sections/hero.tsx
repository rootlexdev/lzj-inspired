"use client";
import OverviewVideo from "@/components/modals/overview-video";
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        <p className="text-xl text-[#64748B] leading-relaxed mb-10 max-w-2xl mx-auto">
                            ...
                            owners complete control over multi-location
                            operations, real-time orders, and financial
                            intelligence — all from a single dashboard.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <Link
                                href={"/get-started"}
                                className="px-8 py-4 rounded-[0.625rem] text-[#0B0D13] font-semibold hover:opacity-90 transition-opacity text-lg cursor-pointer"
                                style={{
                                    padding: "1rem 2rem",
                                    background:
                            ...
                            <button
                                className="px-8 py-4 rounded-[0.625rem] border-2 border-[#F7C74B] text-[#0B0D13] font-semibold hover:bg-[#F7C74B]/10 transition-colors text-lg flex items-center gap-2 cursor-pointer"
                    ...
                    <div className="mt-16 text-center">
                        <p className="text-[#64748B] text-sm mb-6">
                            Trusted by restaurant owners managing multiple
                            locations
                        </p>
